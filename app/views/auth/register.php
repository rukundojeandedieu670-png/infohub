    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="text-center text-muted mb-4">
                Join InfoHub and access opportunities
            </p>
            ...
            <form method="POST" action="<?php echo APP_URL; ?>/auth/register">
                ...
                <div class="grid grid-2" style="margin-bottom: 1.5rem;">
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <input 
                            ...
                            required 
                            placeholder="John"
                            value="<?php echo htmlspecialchars($_SESSION['form_data']['first_name'] ?? $_POST['first_name'] ?? ''); ?>"
                        >
                    </div>
                    ...
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <input 
                            ...
                            required 
                            placeholder="Doe"
                            value="<?php echo htmlspecialchars($_SESSION['form_data']['last_name'] ?? $_POST['last_name'] ?? ''); ?>"
                        >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        value="<?php echo htmlspecialchars($_SESSION['form_data']['phone'] ?? $_POST['phone'] ?? ''); ?>"
                    >
                </div>
                ...
                <div style="margin-bottom: 1.5rem;">
                    <label style="display: flex; align-items: flex-start; gap: 0.5rem; font-weight: 400; margin: 0;">
            ...
            <div style="display: flex; align-items: center; margin: 2rem 0; gap: 1rem;">
                ...
                <span style="color: #999; font-size: 0.9rem;">Or sign up with</span>
                <div style="flex: 1; height: 1px; background: #ddd;"></div>
            </div>
            ...
            <p class="text-center mt-4 text-muted" style="margin-bottom: 0;">
                ...
                <a href="<?php echo APP_URL; ?>/auth/login" style="font-weight: 600; color: var(--primary);">
                    Sign in instead
                </a>
            </p>
